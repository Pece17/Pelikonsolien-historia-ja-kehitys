...
Kuuluisin, mutta myös kiistanalaisin videopelien esi-isistä on Nolan Bushnell. Yliopistossa ollessaan hän kohtasi Steve Russelin Spacewar-pelin, ja käytti sitä perustana vuonna 1970 kehittämälleen Computer Space -pelille. Videopelinä Computer Space ei ollut järin merkillepantava, mutta se oli ensimmäinen kolikkovideopeli ja myös historian ensimmäinen kaupallistettu videopeli, jonka tarkoituksena oli tuottaa rahaa. Computer Space ei ollut yleisömenestys sen monimutkaisten ohjeiden takia, mutta kaksi vuotta myöhemmin Bushnell hioi konseptinsa täydellisyyteen Pong-kolikkovideopelillään
