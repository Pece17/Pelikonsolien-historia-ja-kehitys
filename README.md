...
Vuonna 2005 julkaistun Handbook of Computer Game Studies -kirjan mukaan vuonna 2000 julkaistu PlayStation 2 dominoi markkinoita kirjan kirjoittamisen aikaan, ja se oli suuri menestys alusta asti, aivan kuin ensimmäinen PlayStation. Suosio oli niin suurta, että Sonylla oli vaikeuksia valmistaa tarpeeksi konsoleita. Tilanne tasaantui vasta 2001, johon mennessä yli 50 miljoonaa kotitaloutta ympäri maailman omisti PlayStation 2:en. PlayStation 2 oli ensimmäinen konsoli, joka ylitti tietokoneet suorituskyvyssä - se pystyi käsittelemään yli 60 miljoonaa polygonia sekunnissa ja tarjosi mahtavia mahdollisuuksia pelien ohjelmoijille. Pelit, kuten Gran Turismo 3 sekä Fifa 2002, olivat esimerkkejä siitä, miten vaikuttavia pelit voisivat teknologisesti olla. (Raessens & Goldstein 2005, 42.) Sonyn suureksi eduksi PlayStation-brändistä oli tullut synonyymi pelaamiselle samalla tavalla kuin Nintendo-brändi oli ollut sitä 1980-luvulla. PlayStation 2 oli erittäin odotettu konsoli ja myi hämmästyttävät 980 000 yksikköä Japanissa ensimmäisenä päivänä. PlayStation 2 sisälsi DVD-soittimen, ja oli julkaistessaan sen ajan halvin DVD-soitin, mikä auttoi sen myynnissä ehkä enemmän kuin mikään muu yksittäinen tekijä. Alkuperäisen PlayStationin pelien yhteensopivuus ja USB-portin kautta yhdistettävät monet oheislaitteet, kuten esimerkiksi mikrofonit sekä hiiri, olivat huomioitavia ja merkittäviä ominaisuuksia PlayStation 2 -konsolissa. (Richard 2015, 217-218.)
...
On tietyiltä osin yllättävää, että Microsoftin Xbox-konsoli julkaistiin ollenkaan. Projektin alku voidaan ajoittaa 1999 maaliskuuhun, kun Microsoftin työntekijä Ted Hase lähetti PowerPoint-esitelmän pienelle ryhmälle työntekijöitä, missä vahvasti kannustettiin sen ajan suurinta teknologiayritystä hyppäämään mukaan pelialalle. Microsoftilla oli jo olemassa osasto PC-peleille, mutta nyt lähestymistapana oli luoda kotivideopelikonsoli. Monet yhtiön avainhenkilöistä pitivät ajatusta hulluna, mutta neljän hengen ydinryhmä puski projektia vahvasti eteenpäin, ja he saivat lopulta yhtiön toimitusjohtajan, Steve Ballmerin, tuen. Ydiryhmä uskoi, että tietokonekomponenttien alhaisten hintojen takia Microsoft pystyisi luomaan PlayStation 2:ta tehokkaamman laitteen. Konsolin käyttökokemuksen kannalta oli elintärkeää saada johdon suostumus Windows-pohjaiselle käyttöjärjestelmälle puhtaan Windows-käyttöjärjestelmän sijasta. Itse Bill Gates lykkäsi Xboxin julkaisua vuoteen 2001, koska PlayStation 2:n lyöminen suorituskyvyssä oli olennaista Xboxille. Puhtaan suorituskyvyn puolesta Xbox löikin PlayStation 2:n selvästi: se pystyi teoreettisesti käsittelemään 150 miljoonaa polygonia sekunnissa verrattuna PlayStation 2:n 66 miljoonaan polygoniin sekunnissa. Xboxin muotoilua pidettiin yleisesti rumana, ja se oli konsoliksi valtavan kokoinen. Tämä johtui enimmäkseen siitä, että se hyödynsi tietokoneiden vakiokomponentteja räätälöityjen komponenttien sijasta. Xbox julkaistiin Yhdysvalloissa marraskuussa 2001, ja sen yhteydessä myös tusinan verran pelejä, joista Halo: Combat Evolved osoittautui suurimmaksi yleisömenestykseksi. (Richard 2015, 218-221.)

Nintendo oli aloittanut projektinsa uuden sukupolven konsolin kehitykselle ajoissa jo vuonna 1997, koska N64 ei pystynyt kilpailemaan myynnissä PlayStationin kanssa. 
...
Käytin Google Scholar -hakukonetta lähteiden etsimiseen, mikä osoitti omat haasteensa. Löysin monta laadukkaan tuntuista kirjaa videopelikonsolien historiaan ja kehitykseen liittyen, mutta lähes kaikki tarjosivat vain rajoitetun määrän sivuja esikatseltavaksi. Handbook of Computer Game Studies sekä A Brief History of Video Games -kirjat, joita käytin yhtenä päälähteistäni, onnistuin lainaamaan Internet Archive -kirjastosta tekemällä sinne tilin. Muiden kirjojen kohdalla en ollut yhtä onnekas. Löysin Google Scholarin kautta myös joitakin artikkeleja tieteellisistä julkaisuista liittyen aiheeseeni. Hakusanoina käytin Google Scholarissa "magnavox odyssey history", "history of video game consoles"...
